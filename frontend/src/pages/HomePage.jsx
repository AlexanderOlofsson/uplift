    ...
    <div>
      ...
      <section className="containerSection">
        ...
        <div className="firstSectionText">
          <h2>
            Get motivated to take small steps toward a stronger everyday life!
          </h2>
          <button
            className="signupBtn"
            onClick={() =>
      ...
      <section className="containerSection">
        <div className="secondSectionText">
          ...
          <p>
            Feeling better starts with taking one step at a time. Uplift makes
            it easier to begin with small tasks like going outside, saying hello
            to someone, or taking a break outdoors. Small steps can lead to big
            progress.
          </p>
        </div>
      ...
      <section className="containerSection">
        ...
        <div className="secondSectionText">
          ...
          <p>
            Uplift is inspired by research-backed strategies in mental health
            and motivation. Through achievable, small actions, the app helps you
            gradually improve your well-being, one step at a time.
          </p>
        </div>
      </section>
      ...
      <section className="containerSection">
        <div className="secondSectionText">
          ...
          <p>
            With daily reminders and encouraging challenges, it’s easier to stay
            focused. Uplift nudges you towards simple but meaningful actions
            that bring balance and energy to your everyday life.
          </p>
        </div>
        <div className="secondSectionAnimation">
          <Lottie
      ...
      <h1 ref={ref} className={`countUsers ${inView ? "fade-in" : ""}`}>
        <CountUp
          ...
          duration={10}
          prefix="Join Our Community of "
          suffix="+ Satisfied Users"
        />
      </h1>
